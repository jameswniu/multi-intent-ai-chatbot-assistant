...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'curve': 'basis', 'nodeSpacing': 22, 'rankSpacing': 34, 'padding': 6}, 'themeVariables': {'primaryColor': '#20242b', 'primaryTextColor': '#e7e5e0', 'primaryBorderColor': '#3a3f47', 'lineColor': '#6b7f99', 'textColor': '#c9c7c1', 'edgeLabelBackground': '#20242b', 'fontSize': '14px'}}}%%
flowchart LR
    Q[question] --> G[guard]
    ...
    style R1 stroke:#b5654a,color:#d0705a
    style R2 stroke:#b5654a,color:#d0705a
    style A color:#9a9a93
    style O stroke:#7aa6d8,color:#7aa6d8
```
