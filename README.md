...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'curve': 'basis', 'nodeSpacing': 30, 'rankSpacing': 30, 'padding': 8}, 'themeVariables': {'primaryColor': '#1a1f26', 'primaryTextColor': '#e6e8eb', 'primaryBorderColor': '#2b3138', 'lineColor': '#6b7f99', 'fontSize': '16px'}}}%%
flowchart TD
