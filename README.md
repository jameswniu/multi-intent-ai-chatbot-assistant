...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'curve': 'basis', 'nodeSpacing': 22, 'rankSpacing': 34, 'padding': 6}, 'themeVariables': {'primaryColor': '#1a1f26', 'primaryTextColor': '#e6e8eb', 'primaryBorderColor': '#2b3138', 'lineColor': '#6b7f99', 'textColor': '#c3c8ce', 'edgeLabelBackground': '#1a1f26', 'fontSize': '14px'}}}%%
flowchart LR
    Q[question] --> G[guard]
