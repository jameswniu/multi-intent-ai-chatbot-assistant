...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'curve': 'basis'}, 'themeVariables': {'primaryColor': '#20242b', 'primaryTextColor': '#e7e5e0', 'primaryBorderColor': '#3a3f47', 'lineColor': '#7aa6d8', 'textColor': '#e7e5e0', 'edgeLabelBackground': '#20242b', 'fontFamily': '-apple-system, BlinkMacSystemFont, Segoe UI, Helvetica, Arial, sans-serif', 'fontSize': '16px'}}}%%
flowchart TD
