...
<img alt="routes 42 of 54 labelled questions to the agent a person would pick" src="https://img.shields.io/badge/routes-42_of_54_labelled_questions-4f6d8f?style=flat-square&labelColor=0f1216">
<img alt="SQL validated, 26 of 26 generated statements" src="https://img.shields.io/badge/SQL_validated-26_of_26-5b6470?style=flat-square&labelColor=0f1216">
<img alt="literal injection probes refused, 7 of 7" src="https://img.shields.io/badge/literal_probes_refused-7_of_7-5b6470?style=flat-square&labelColor=0f1216">
<img alt="PII redacted, 5 of 5 strings in the formats it names" src="https://img.shields.io/badge/PII-5_of_5_named_formats-5b6470?style=flat-square&labelColor=0f1216">
<img alt="every number on this page is recounted in CI on every push" src="https://img.shields.io/badge/numbers-recounted_in_CI_on_every_push-4f6d8f?style=flat-square&labelColor=0f1216">
<img alt="license Apache-2.0" src="https://img.shields.io/badge/license-Apache--2.0-5b6470?style=flat-square&labelColor=0f1216">
...
```mermaid
%%{init: {'theme': 'base', 'flowchart': {'curve': 'basis', 'nodeSpacing': 30, 'rankSpacing': 30, 'padding': 8}, 'themeVariables': {'primaryColor': '#1a1f26', 'primaryTextColor': '#e6e8eb', 'primaryBorderColor': '#2b3138', 'lineColor': '#6b7f99', 'textColor': '#c3c8ce', 'edgeLabelBackground': '#1a1f26', 'fontSize': '16px'}}}%%
flowchart TD
    G[guard] -->|matched| R1[refused]
    G --> C[classify]
    C -->|contract| S[select columns]
    C -->|knowledge| F[retrieve]
    C -->|tie| A[ask again]
    S --> V[validate]
    ...
    F --> P
    P --> O[answer]
    style G stroke:#b5654a,stroke-width:1.5px
    style V stroke:#b5654a,stroke-width:1.5px
    style R1 stroke:#b5654a,color:#c2765a
    style R2 stroke:#b5654a,color:#c2765a
    style A color:#9a9a93
    style O stroke:#7f9bb8,color:#7f9bb8
```
